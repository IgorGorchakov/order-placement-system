...
public class GlobalExceptionHandler extends BaseExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBookingNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(createErrorResponse("BOOKING_NOT_FOUND", ex.getMessage(), request.getRequestURI()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleTripNotFound(
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(createErrorResponse("TRIP_NOT_FOUND", ex.getMessage(), request.getRequestURI()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleSeatNotAvailable(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(createErrorResponse("SEAT_NOT_AVAILABLE", ex.getMessage(), request.getRequestURI()));
    }
